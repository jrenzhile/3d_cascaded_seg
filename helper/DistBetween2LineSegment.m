...
% Output: scalar minimum distance between the two line segments.

%  Example:
%	P1 = [0 0 0];     P2 = [1 0 0];
%   P3 = [0 1 0];     P4 = [1 1 0];
%	dist = DistBetween2LineSegment(P1, P2, P3, P4)
%   dist =
%
%    1
% 
...
function distance = DistBetween2LineSegment(p1, p2, p3, p4)
    u = p1 - p2;
    v = p3 - p4;
    w = p2 - p4;
